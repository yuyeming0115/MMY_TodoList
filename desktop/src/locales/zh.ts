export default {
  ...
  settings: {
    ...
    backupQuick: '快速备份',
    backupFull: '完整备份',
    backupTypeQuick: '快速（不含图片）',
    backupTypeFull: '完整（含图片）',
    defaultBackupType: '默认备份类型',
    ...
    categoriesCount: '分类数',
    tasksCount: '任务数',
    clipboardItemsCount: '剪贴板项目数',
    clipboardImageCount: '图片项目数',
    restoreOptions: '恢复选项',
    overwriteMode: '覆盖模式',
    mergeMode: '合并模式',
    restoreTasks: '恢复任务数据',
    restoreClipboard: '恢复剪贴板数据',
    restoreSettings: '恢复应用设置',
    confirmRestore: '确认恢复',
    quickRestore: '快速恢复',
    backupHistory: '备份历史',
    restore: '恢复',
